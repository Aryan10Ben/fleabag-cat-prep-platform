      ...
      <div className="flex border-b dark:border-slate-800 gap-6 text-sm font-semibold">
        <button
          ...
          className={`pb-3 flex items-center gap-1.5 border-b-2 transition-all ${
            activeTab === "manual" ? "border-indigo-600 text-indigo-600" : "border-transparent text-slate-400"
          }`}
        >
        ...
        <button
          ...
          className={`pb-3 flex items-center gap-1.5 border-b-2 transition-all ${
            activeTab === "bulk" ? "border-indigo-600 text-indigo-600" : "border-transparent text-slate-400"
          }`}
        >
        ...
        <button
          ...
          className={`pb-3 flex items-center gap-1.5 border-b-2 transition-all ${
            activeTab === "pyq" ? "border-indigo-600 text-indigo-600" : "border-transparent text-slate-400"
          }`}
        >
        ...
        <form onSubmit={handleManualSubmit} className="bg-white dark:bg-slate-950 p-6 md:p-8 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm space-y-6">
          ...
          <div className="space-y-1">
            ...
            <textarea
              ...
              className="w-full px-4 py-3 border rounded-xl bg-slate-50/50 dark:bg-slate-900 text-xs focus:outline-none focus:border-indigo-500 font-sans leading-relaxed"
            />
          </div>
          ...
          <div className="space-y-1">
            ...
            <textarea
              ...
              className="w-full px-4 py-3 border rounded-xl bg-slate-50/50 dark:bg-slate-900 text-xs focus:outline-none focus:border-indigo-500 font-mono leading-relaxed"
            />
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="px-6 py-3 bg-indigo-600 hover:bg-blue-700 text-white rounded-xl text-xs font-bold shadow-md shadow-blue-500/10 flex items-center gap-1.5"
          >
        ...
        <div className="bg-white dark:bg-slate-950 p-6 md:p-8 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm space-y-6">
          <div className="space-y-1">
            <h2 className="text-base font-bold flex items-center gap-2">
              <Sparkles className="h-5 w-5 text-indigo-600" /> Similar Question Generator
            </h2>
          ...
          <div className="space-y-4">
            <div className="space-y-1">
              ...
              <select
                ...
                className="w-28 px-3 py-2 border rounded-lg bg-slate-50 dark:bg-slate-900 text-xs focus:outline-none focus:border-indigo-500"
              >
                <option value="EASY">EASY</option>
                <option value="MEDIUM">MEDIUM</option>
                <option value="HARD">HARD</option>
            ...
            <div className="space-y-1">
              ...
              <textarea
                ...
                className="w-full px-4 py-3 border rounded-xl bg-slate-50 dark:bg-slate-900 text-xs focus:outline-none focus:border-indigo-500"
              />
            </div>
            ...
            <button
              ...
              disabled={loading}
              className="px-6 py-3 bg-slate-900 hover:bg-slate-800 dark:bg-indigo-600 dark:hover:bg-blue-700 text-white rounded-xl text-xs font-bold shadow-md shadow-blue-500/10 flex items-center gap-1.5"
            >
              {loading ? (
                <>
          ...
          {aiResult && (
            <div className="mt-8 border-t dark:border-slate-800 pt-6 space-y-4 animate-fadeIn">
              <div className="p-4 rounded-2xl bg-indigo-50/40 dark:bg-slate-900 border border-indigo-500/10 space-y-2 text-xs">
                <span className="font-bold text-indigo-600 dark:text-indigo-400 flex items-center gap-1.5"><CheckCircle className="h-4 w-4" /> Topic Detection Complete</span>
              ...
              <div className="space-y-4">
                ...
                {aiResult.questions.map((q, idx) => (
                  <div key={idx} className="p-5 border border-slate-100 dark:border-slate-800 rounded-2xl bg-slate-50/20 space-y-4">
                    ...
                    <div className="p-3.5 bg-indigo-50/30 dark:bg-slate-900 rounded-xl text-xs space-y-1.5 font-mono leading-relaxed">
