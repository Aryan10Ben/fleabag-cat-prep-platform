      ...
      <div className="relative bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-2xl max-w-lg w-full overflow-hidden shadow-2xl p-6 space-y-6 animate-fadeInUp">
        ...
        <div className="flex justify-between items-center pb-2">
          <div className="flex items-center gap-2">
            <div className="h-8 w-8 bg-indigo-50 dark:bg-blue-950/30 text-indigo-600 dark:text-indigo-400 rounded-lg flex items-center justify-center">
              <Target className="h-5 w-5" />
            </div>
            <div>
              <h3 className="text-base font-bold text-slate-900 dark:text-white">Configure Daily Targets</h3>
              <p className="text-xs tracking-wide text-slate-400 dark:text-slate-500">Personalize your daily questions goal per section</p>
            </div>
          </div>
          <button 
            onClick={onClose}
        ...
        <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-800/80 space-y-3">
          ...
          <div className="flex justify-between text-xs tracking-wide text-slate-400">
        ...
        <div className="space-y-4 pt-2">
          ...
          <div className="grid grid-cols-12 gap-4 items-center">
            <div className="col-span-5 space-y-1">
              <h4 className="text-xs font-bold text-slate-800 dark:text-slate-300">Quantitative Aptitude</h4>
              <div className="flex items-center gap-1.5 text-xs tracking-wide font-semibold text-indigo-600 dark:text-indigo-400 mt-1">
            ...
            <div className="col-span-4 flex items-center justify-end gap-1.5">
              <button 
                ...
                className="h-7 w-7 border border-slate-200 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-600 dark:text-slate-300 rounded-lg flex items-center justify-center transition-colors"
              >
              ...
              <input
                ...
                className="w-12 text-center text-xs font-bold py-1 border border-slate-200 dark:border-slate-800 bg-transparent rounded-lg focus:outline-none focus:border-indigo-500"
              />
              <button 
                onClick={() => adjustQuant(5)}
                className="h-7 w-7 border border-slate-200 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-600 dark:text-slate-300 rounded-lg flex items-center justify-center transition-colors"
          ...
          <div className="grid grid-cols-12 gap-4 items-center">
            <div className="col-span-5 space-y-1">
              <h4 className="text-xs font-bold text-slate-800 dark:text-slate-300">Verbal Ability & RC</h4>
              <div className="flex items-center gap-1.5 text-xs tracking-wide font-semibold text-indigo-600 dark:text-indigo-400 mt-1">
          ...
          <div className="grid grid-cols-12 gap-4 items-center">
            <div className="col-span-5 space-y-1">
              <h4 className="text-xs font-bold text-slate-800 dark:text-slate-300">Logical Reasoning & DI</h4>
              <div className="flex items-center gap-1.5 text-xs tracking-wide font-semibold text-emerald-600 dark:text-emerald-400 mt-1">
        ...
        <div className="flex justify-end gap-3 pt-3 border-t border-slate-100 dark:border-slate-800">
          ...
          <button
            ...
            className="px-5 py-2 bg-indigo-600 hover:bg-blue-700 text-white rounded-xl text-xs font-bold transition-all disabled:opacity-50 flex items-center gap-1.5 shadow-md shadow-blue-500/10"
          >
            {saveSuccess ? (
              <>
